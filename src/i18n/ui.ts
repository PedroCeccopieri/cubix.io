...
const en: UiDict = {
  ...
  puzzlesPageDescription: "Pick a puzzle to see the available methods, the course steps and every case with its algorithms.",
...
const es: UiDict = {
  nav: {
    home: { label: "Inicio", short: "Inicio" },
    puzzles: { label: "Puzzles", short: "Puzzles" },
    methods: { label: "Métodos", short: "Métodos" },
    progress: { label: "Mi progreso", short: "Progreso" },
    about: { label: "Acerca de", short: "Acerca" },
  },
  ...
  view: "Ver",
  methodCount: (n) => (n === 1 ? "método" : "métodos"),
  yourProgress: "Tu progreso",
  progress: "Progreso",
  cases: "casos",
  casesOf: (done, total) => `${done}/${total} casos`,
  learnedOf: (done, total) => `${done} de ${total} casos aprendidos`,
  platformLearnedOf: (done, total) => `${done} de ${total} casos aprendidos en la plataforma`,
  startLearning: "Empezar a aprender",
  learned: "Aprendido",
  markLearned: "Marcar como aprendido",
  caseLearned: "Caso aprendido",
  studyCase: "Estudiar caso →",
  algorithms: "Algoritmos",
  algCopied: "Algoritmo copiado",
  ...
  difficultyOf: (n) => `Dificultad ${n} de 5`,
  ...
  open: "Abrir →",
  puzzleProgress: "Progreso del puzzle",
  ...
  methodsFallbackHead: "Métodos y algoritmos para resolver el puzzle.",
  courseFallbackHead: "Curso completo con etapas, casos y algoritmos.",
  libraryEyebrow: "Biblioteca",
 ...
 * Idiomas sem dicionário caem automaticamente no inglês.
 */
export const ui: Partial<Record<Lang, UiDict>> & { en: UiDict } = { pt, en, es };
